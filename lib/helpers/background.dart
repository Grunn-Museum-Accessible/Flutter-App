...
Stack printClippedText(
    String text, TextStyle styleFront, TextStyle styleBack, double offset) {
  return Stack(
    children: [
      /**
...
class Clipper extends CustomClipper<Path> {
  final bool inverted;
  const Clipper({required this.inverted});
...
Path getPath(Size size) {
  return Path()
    ..moveTo(0, 150)
    ..lineTo(0, 150)
    ..quadraticBezierTo(size.width / 4, 50, size.width, 150)
